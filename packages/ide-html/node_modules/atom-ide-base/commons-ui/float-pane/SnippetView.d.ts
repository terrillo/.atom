...
export declare function SnippetView(props: Props): import("solid-js").JSX.Element;
/**
 ...
 */
export declare function getSnippetHtml(snipetsGiven: Array<string> | string, grammarName?: string, renderer?: MarkdownService): Promise<string | null>;
