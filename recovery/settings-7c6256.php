...
if ($_SERVER["SERVER_NAME"] == 'localhost') {
   ...
   * Stage
   */
  if ($_SERVER["SERVER_NAME"] == 'stage1.brief.vet') {
    $datab = 'stage1';
  }
  if ($_SERVER["SERVER_NAME"] == 'stage2.brief.vet') {
   $datab = 'stage2';
  }
  if ($_SERVER["SERVER_NAME"] == 'stage3.brief.vet') {
   $datab = 'stage3';
  }
  if ($_SERVER["SERVER_NAME"] == 'stage4.brief.vet') {
   $datab = 'stage4';
  }
   ...
   * Live
   */
  if ($_SERVER["SERVER_NAME"] == 'cb.brief.vet' || $_SERVER["SERVER_NAME"] == 'vtb.brief.vet') {
    $datab = 'Drupal8';
  }
...
/**
 * S3 File System Extension
 */
// if (file_exists($app_root . '/modules/_devops/s3fs/vendor/autoload.php')) {
// 	require $app_root . '/modules/_devops/s3fs/vendor/autoload.php';
